...
ds = dbutils.fs.ls('/databricks-datasets') # using dbutils, you can use Python to access the returned value
print(ds)

# COMMAND ----------

display(ds) # use display() to show table in notebook
